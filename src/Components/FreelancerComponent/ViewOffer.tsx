              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <label className="flex items-center mb-4">
                  <input
                    ...
                    onChange={(e) => {
                      setOfferData((prev) => ({ ...prev, termsAccepted: e.target.checked }));
                      console.log("Checkbox Clicked - Terms Accepted:", e.target.checked);
                    }}
                ...
                {offerStatus == 'pending' ? (
                  ...
                  <button
                    disabled
                    className={`w-full px-6 py-3 ${offerStatus === 'accepted' ? 'bg-green-500' : 'bg-red-500'
