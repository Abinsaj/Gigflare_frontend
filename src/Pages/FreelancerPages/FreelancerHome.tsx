    ...
    return (
        <>
            ...
            <section className="bg-white dark:bg-gray-900 relative">
                <div className="relative w-full lg:h-[600px] md:h-[500px] sm:h-[400px] h-[300px] flex items-center justify-center text-center">
                    <img
                    ...
                    {/* Statistics Section */}
                    <div className="absolute bg-white/50 bottom-4 md:bottom-8 lg:bottom-10 w-full flex flex-wrap justify-center gap-4 lg:gap-32 px-4 py-2 md:h-28">
            ...
            <div className="bg-white p">
                <div className="mx-auto max-w-full  md:max-w-2xl lg:max-w-7xl lg:px-6 py-5 sm:py-10 lg:py-24">
                    ...
                    <div className='grid grid-cols-1 gap-x-5 gap-y-7  xl:grid-cols-4 lg:grid-cols-2 sm:grid-cols-1 '>
                        {products.map((pdt)=>(
                            ...
                            <Card className="col-span-12  rounded-sm sm:col-span-4 h-[300px]">
